...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)CellIdentifier {
    ...
    if (self) {
        ...
        tempTitleLabel.lineBreakMode = NSLineBreakByWordWrapping | NSLineBreakByTruncatingTail;
        ...
        tempTimeLabel.lineBreakMode = NSLineBreakByWordWrapping | NSLineBreakByTruncatingTail;
        ...
        tempInfoLabel.lineBreakMode = NSLineBreakByWordWrapping | NSLineBreakByTruncatingTail;
