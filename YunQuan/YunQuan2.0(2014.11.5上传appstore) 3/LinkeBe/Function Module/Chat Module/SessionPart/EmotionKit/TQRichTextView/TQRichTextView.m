                             ...
                             lineSpacing:(CGFloat)lineSpacing;
{
    ...
    NSString *string = [TQRichTextView analyzeText:text textRunsArray:runArray font:font];
    NSMutableString *fixString = [NSMutableString stringWithString:string];
    for (int i=0; i<[runArray count]; i++)
    {
        [fixString insertString:@"正" atIndex:0];
    }
    NSString *analyzeText = fixString;
