...
@property (nonatomic, retain) UILabel *newCicleLable;
@property (nonatomic, retain) UILabel *unreadLabel;
@property (nonatomic, retain) UILabel *newDynamicLabel;
@property (nonatomic, retain) UILabel *newMySelfCommentLabel;
